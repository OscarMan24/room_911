<div class="modal fade" id="editEmpleoyee" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
    wire:ignore.self>
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
                ...
                <div class="row">
                    <div class="col-md-6 col-12 mb-3">
                        ...
                        <input type="text" class="form-control @error('name_employee') is-invalid @enderror"
                            placeholder="{{ __('Name') }}" wire:model.defer="name_employee"
                            wire:target="editEmpleoyee" wire:loading.attr="disabled">
                        @error('name_employee')
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <input type="file" class="form-control @error('image') is-invalid @enderror" accept="image/*"
                            wire:model="image" wire:target="editEmpleoyee" wire:loading.attr="disabled">
                        @error('image')
                            <div class="invalid-feedback ">{{ $message }} </div>
                        @enderror
                    ...
                    <div wire:loading wire:target="editEmpleoyee">
                        <div class="progress">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" wire:target="editEmpleoyee" wire:loading.attr="disabled"
                    data-bs-dismiss="modal" wire:click="clean()">{{ __('Cancel') }}</button>
                <button type="button" class="btn btn-primary" wire:target="editEmpleoyee" wire:loading.attr="disabled"
                    wire:click="editEmpleoyee()">{{ __('Save') }}</button>
            </div>
        </div>
    </div>
</div>
